 ...
 */
function callback_weeksrev_uses_sections() {
    return true;
}

/**
 * Used to display the course structure for a course where format=weeksrev
 *
 ...
 */
function callback_weeksrev_load_content(&$navigation, $course, $coursenode) {
    return $navigation->load_generic_course_sections($course, $coursenode, 'weeksrev');
}
 ...
 * @return string
 */
function callback_weeksrev_definition() {
 ...
 * @return string
 */
function callback_weeksrev_get_section_name($course, $section) {
 ...
 * @return stdClass
 */
function callback_weeksrev_ajax_support() {
 ...
 */
function format_weeksrev_get_section_dates($section, $course) {
 ...
 */
function callback_weeksrev_ajax_section_move($course) {
    global $COURSE, $PAGE;
