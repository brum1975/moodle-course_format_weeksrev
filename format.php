...
/// Everything below uses "section" terminology - each "section" is a week.
    ...
    $weekdate = $course->enddate-$weekofseconds;    // this should be 0:00 Monday of that week
    $weekdate += 7200;                 // Add two hours to avoid possible DST problems
    
    
    $strftimedateshort = ' '.get_string('strftimedateshort');

    while ($weekdate > $course->startdate) {
        ...
        if($weekdate>$timenow and !has_capability('moodle/course:viewhiddensections', $context)){
        ...
        if ($showsection) {
            ...
            $currentweek = (($weekdate <= $timenow) && ($timenow < $weekdate+$weekofseconds));
